...
I just copied a blank *.Rmd* file into the folder <span class="texttt"> /content/post </span>. I gave it a different name than the other post, using the date and some explanatory text (I called it "*2017-08-22-new-post.Rmd*").  
